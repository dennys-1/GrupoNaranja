...
namespace inicio.Controllers
{
    public class ProformaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserID,Cantidad,Precio")] Proforma proforma)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserID,Cantidad,Precio")] Proforma proforma)
        {
            if (id != proforma.Id)
            {
                return NotFound();
